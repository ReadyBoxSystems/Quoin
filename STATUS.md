...
- `origin/main` is `58880c1` (`Improve Excel import guidance and sheet UX`).
- Local `main` is one commit ahead at `2dcded4` (`Support lookup formulas as calculation primitives`).
